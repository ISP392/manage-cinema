<%-- 
    Document   : homeAdmin
    Created on : Jun 10, 2024, 11:31:16 PM
    Author     : baoquoc
--%>
              ...
              <div class="card bg-info invoice-card">
                <div class="card-body d-flex">
                  ...
                  <div>
                    ...
                    <span class="text-white fs-18">chua nghi ra</span>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="card bg-secondary invoice-card">
                <div class="card-body d-flex">
                  ...
                  <div>
                    ...
                    <span class="text-white fs-18">chua nghi ra 2</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="row">
                  ...
                  <div class="row align-items-center">
                    <div class="col-xl-6">
                      <div class="card-bx bg-blue">
                        <img
                          class="pattern-img"
                          src="./assets/images/pattern/pattern6.png"
                          alt=""
                        />
                        ...
                        <a class="change-btn" href="javascript:void(0);"
                          ><i class="fa fa-caret-up up-ico"></i>Change<span
                            class="reload-icon"
                            ><i class="fas fa-sync-alt reload active"></i></span
                        ></a>
                      </div>
                    </div>
                    <div class="col-xl-6">
            ...
            <div class="col-xl-3 col-xxl-7">
              <div class="card">
                ...
                <div class="card-body">
                  <div class="user-bx">
                      <img src="./assets/images/avatar/avatar.jpeg" alt="" />
                    <div>
                  ...
                  <ul class="user-list">
                    <li><img src="./assets/images/avatar/avatar.jpeg" alt="" /></li>
                    <li><img src="./assets/images/avatar/avatar.jpeg" alt="" /></li>
                    <li><img src="./assets/images/avatar/avatar.jpeg" alt="" /></li>
                    <li><img src="./assets/images/avatar/avatar.jpeg" alt="" /></li>
                    <li><img src="./assets/images/avatar/avatar.jpeg" alt="" /></li>
                  ...
                  <div
                    class="text-secondary fs-16 d-flex justify-content-between font-w600 mt-4"
                  >
            ...
            <div class="col-xl-6 col-xxl-7">
              <div class="card">
                <div class="card-header d-flex flex-wrap border-0 pb-0">
                  ...
                  <a
                    href="javascript:void(0)"
                    class="btn btn-rounded btn-md btn-primary me-3 me-3"
                ...
                <div class="card-body pb-2">
                  <div class="d-sm-flex d-block">
                    ...
                    <div
                      class="form-check toggle-switch text-end form-switch me-auto"
                    >
                      <input
                        class="form-check-input"
                        type="checkbox"
                ...
                <div class="card-body tab-content p-0">
                  ...
                  >
                    <div class="table-responsive">
                      <table
                        class="table table-responsive-md card-table transactions-table"
                      >
                        <tbody>
                          <tr>
                            <td>
                            ...
                            <td>
                              <span
                                class="text-success fs-16 font-w500 text-end d-block"
                                >Completed</span
                              >
                            </td>
                          </tr>
                          <tr>
                            ...
                            <td>
                              <span
                                class="text-warning fs-16 font-w500 text-end d-block"
                                >Pending</span
                              >
                            </td>
                          </tr>
                          <tr>
                            ...
                            <td>
                              <span
                                class="text-danger fs-16 font-w500 text-end d-block"
                                >Canceled</span
                              >
                            </td>
                          </tr>
