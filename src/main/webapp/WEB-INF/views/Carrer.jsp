                  ...
                  <tr style="border-radius: 20px">
                    ...
                    >
                      ...
                      <p style="padding-block-start: 10px">
                        ...
                        ": Gửi CV đến email"
                        <strong>cgvtalent@cj.net</strong> với tiêu đề "[HỌ TÊN]
                        - Ứng tuyển [VỊ TRÍ]”.
                      </p>
                      <p>
                        <strong>Cách 2</strong>
                        : Nộp hồ sơ trực tiếp trên các trang tuyển dụng uy tín
                        mà BANNY có đăng tuyển như Linkedin, Vietnamwork,
                        Careerbuilder, Hoteljob, Vieclam24, TopCV ….
                      </p>
                    </td>
                  </tr>
                </tbody>
