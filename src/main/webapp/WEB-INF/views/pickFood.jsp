...
<head>
    ...
    <style>
        ...
        .bill-summary h2, .previous-orders h2 {
            text-align: center;
            margin-bottom: 20px;
            color: #333;
        }
        .bill-summary table, .previous-orders table {
            width: 100%;
            border-collapse: collapse;
        }
        .bill-summary th, .bill-summary td, .previous-orders th, .previous-orders td {
            border: 1px solid #ddd;
            padding: 10px;
            text-align: center;
            color: #555;
...
<body>
    ...
    <div class="container1">
        <div class="section selected-movie fixed-section">
            ...
            <p>Tổng tiền vé: <span id="ticketPrice">${totalPrice}</span> VND</p>
        </div>
                    ...
                    <div class="food-item">
                        ...
                        <div class="food-item-details">
                            ...
                            <div class="order-controls">
                                <div class="quantity">
                                    <button onclick="updateQuantity(this, -1, ${item.price}, '${item.foodName}')">-</button>
        ...
        <div class="section order-summary fixed-section">
            ...
            <table>
                ...
                <tfoot>
                    <tr class="total-row">
                        <td style="padding:10px; font-size: 20px; font-weight: bold"  colspan="2" class="total">Tổng cộng:</td>
                        <td style="padding:10px; font-size: 20px; font-weight: bold" class="total" id="totalPrice">0 VNĐ</td>
                    </tr>
                </tfoot>
            </table>
        </div>
