          ...
          <div class="top-content">
            <div class="products-list">
              ...
              <p>
                ...
                ~
                <fmt:formatDate
                  value="${screeningTimes.getEndTime()}"
                  pattern="yyyy-MM-dd HH:mm"
                />
              </p>
            </div>
                              ...
                              <div class="group">
                                ...
                                >
                                  ...
                                  <c:forEach var="s" items="${SWS}">
                                    ...
                                    >
                                      <label
                                        class="seat ${rowIndex ge vipSeat[2] && rowIndex le vipSeat[3] && col ge vipSeat[0] && col le vipSeat[1] ? 'seat-vip' : 'seat-occupied'} active"
                                        loc="${seatCode}"
                                        price="75000"
                                        >${seatCode}</label
                                      >
                                  ...
                                  <c:if test="${!seatFound}">
                                    <label
                                      class="seat ${rowIndex ge vipSeat[2] && rowIndex le vipSeat[3] && col ge vipSeat[0] && col le vipSeat[1] ? 'seat-vip' : 'seat-standard'}"
                    ...
                    <div class="bottom-content">
                      <div class="minicart-wrapper">
                        <ul>
                          <li class="item-first">
                            <div class="product-detail" style="width: 30vh">
                              <img
                                src="${screeningTimes.getMovieID().getPosterImage()}"
                                width="74px"
                                height="108px"
                                alt="alt"
                              />
                        ...
                        <input
                          type="hidden"
                          name="movieTitle"
                          value="${screeningTimes.getMovieID().getTitle()}"
                        />
                        <input
                          type="hidden"
                          name="cinemaName"
