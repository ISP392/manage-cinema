            ...
            <div class="dashboard">
                ...
                <div class="format-profile" style="font-weight: bold; margin-bottom: 15px">
                    ...
                    <div class="form-outline mb-4">
                        ...
                        <input type="text" value="${sessionScope.account.email}" id="email" name="email" required class="form-control form-control-lg" />
                    </div>
                    <div class="form-outline mb-4">
                    ...
                    <div class="form-outline mb-4">
                        ...
                        <input type="password"  name="newPassword" id="new-password" class="form-control form-control-lg" />
                    </div>
                    <div class="form-outline mb-4">
