<%-- Document : homeAdmin Created on : Jun 10, 2024, 11:31:16 PM Author : baoquoc --%>
        ...
        <div class="content-body">
          ...
          <div class="container-fluid">
            ...
            <form action="update_movie" method="post">
                  ...
                  <div class="row">
                    <div class="col-xl-12">
                      <div class="mb-3">
                        ...
                        <input type="text" class="form-control" placeholder="Title" name="movieTitle"
                      ...
                      <div class="card h-auto">
                        <div class="card-body pt-3">
                          <textarea id="description" style="margin-top: 10px" class="form-control" name="description"
                            required>
                        ...
                        <div class="cm-content-body form excerpt">
                          <div class="card-body">
                            <div class="genre-buttons">
                              <button type="button" value="1" class="genre-button">
                                Hành Động
                              </button>
                              <button type="button" value="2" class="genre-button">
                                Phưu Lưu
                              </button>
                              <button type="button" value="3" class="genre-button">
                                Tâm Lý
                              </button>
                              <button type="button" value="4" class="genre-button">
                                Tình Cảm
                              </button>
                              <button type="button" value="5" class="genre-button">
                                Kinh Dị
                              </button>
                              <button type="button" value="6" class="genre-button">
                                Gia Đình
                              </button>
                              <button type="button" value="7" class="genre-button">
                                Hài
                              </button>
                              <button type="button" value="8" class="genre-button">
                                Hoạt Hình
                              </button>
                              <button type="button" value="9" class="genre-button">
                                Hồi Hộp
                              </button>
                            </div>
                          </div>
                              ...
                              <div class="position-relative">
                                <div class="avatar-preview">
                                  <div id="imagePreview" style="
                                    background-image: url(${movie.posterImage});
                                  "></div>
                                </div>
                                <div class="change-btn d-flex align-items-center flex-wrap">
                                  <input type="text" class="form-control" placeholder="New Poster Image"
                                    name="poster_image" id="posterImage" />
                                  <input type="text" class="form-control d-none" id="imageUpload" name="posterImage"
                      ...
                      <input type="hidden" id="selectedGenresBefore" value="${genresID}" />
              ...
              <button id="submitButton" type="submit" class="btn btn-primary mb-3 open">
                Update Movie
              </button>
              <button class="btn btn-primary mb-3 open" style="background-color: #ee2279; border: #ee2279"
