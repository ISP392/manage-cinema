...
@WebServlet(name = "updateDisplayRecruitment", urlPatterns = {"/updateDisplayRecruitment"})
public class updateDisplayRecruitment extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (u == null || u.getRoleID().getRoleID() != 1) {
            ...
            DAO dao = new DAO();
            int rId = Integer.parseInt(recruitmentID);
            int dis = Integer.parseInt(display);
            dao.updateDisplayRecruitmentByRecruitmentID(rId, dis);
