                                        ...
                                        <div class="col-xl-12">
                                            ...
                                            <div class="mb-3">
                                                <label for="startTimeInput">Giờ bắt đầu chiếu: (nên chọn giờ
                                                    chẵn)</label><br>
                                                <input class="form-control" type="time" id="startTimeInput" required
                                                    name="startTimeInput">
                                            </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" style="appearance: none;" type="time"
                                                    readonly id="endTimeInput" required name="endTimeInput">
                                            </div>
