                    ...
                    <div class="row gx-lg-5 align-items-center">
                        ...
                        <div class="col-lg-6 mb-5 mb-lg-0">
                            <div class="card" style="border-radius: 2.25rem">
                                <div class="card-body py-5 px-md-5" style="height: 490px">
                                    <form>
                                        <h2
                                            style="
                                            text-align: center;
                                        ...
                                        <div>
                                            <button
                                                ...
                                                style="
                                                background-color:  #0F8D65
                                                ; border-radius: 20px; height: 43px;
                                                font-weight: bold;
                                                font-size: 15px;
                                                "
                                                >
                                            ...
                                            <div class="row mb-4">
                                                ...
                                                <div style="display: flex; flex: 1; margin: 0 15px">
                                                    <div class="gsi-material-button">
                                                        <a
                                                            href="https://accounts.google.com/o/oauth2/auth?scope=email%20profile%20openid&redirect_uri=${localhost}/manage-cinema/LoginGoogleHandler&response_type=code&client_id=289651568773-962elblss4e85nrbgrri0i3kcor4pfl8.apps.googleusercontent.com&approval_prompt=force">                                                            <div class="gsi-material-button-state"></div>
