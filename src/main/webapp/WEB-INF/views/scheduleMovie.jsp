        ...
        <div class="container">
            ...
            <div class="date-movie" style="width:100%">
                ...
                <div class="calendar" id="calendar">
                    ...
                    <a href="booking?movieid=${movieID}&date=<%= daysOfMonth.get(i) %>&direction=<%= request.getParameter("direction") != null ? request.getParameter("direction") : "2" %>" class="day-link">
            ...
            <div class="address">
                <ul style="display:flex; padding:0">
                    <c:forEach var="direction" items="${listDirection}">
                        <div>
                            <li class="direction ${direction.locationID == Integer.parseInt(param.direction) ? 'active' : ''}">
                                <span><a href="booking?movieid=${movieID}&date=<%= request.getParameter("date")%>&direction=${direction.locationID}">${direction.name}</a></span>
                            </li>
                        </div>
                    </c:forEach>
                </ul>
