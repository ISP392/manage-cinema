                    ...
                    <div class="format-profile">
                        ...
                        <div class="box-account box-info">
                            <div
                                ...
                                "
                                >
                                <span style="font-weight: bold; font-size: 25px">Thông tin tài khoản</span>
                                <div
                                    style="
                                    ...
                                    <ul style="margin: 0; padding: 0; list-style: none">
                                        <li>
                                            <button style="background-color: #445760; border-radius: 7px; margin-bottom: 13px"
                                                    ><a href="update" style="color: #ccffff">Thay đổi</a></button>
                                        </li>
                                    </ul>
                                </div>
                            </div>
