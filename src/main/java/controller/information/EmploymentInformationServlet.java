...
public class EmploymentInformationServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        String content = "New employment application received:\n\n" +
                         "Name: " + name + "\n" +
                         "Email: " + email + "\n" +
                         "Phone: " + phone + "\n" +
                         "Date of Birth: " + dob + "\n" +
        ...
        boolean sendMail = Email.sendEmail("daothihabg03@gmail.com", "new employment application", content);
        //response.sendRedirect("employmentInformation");
