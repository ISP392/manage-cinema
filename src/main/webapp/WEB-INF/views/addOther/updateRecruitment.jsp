        ...
        <div id="main-wrapper">
                    ...
                    <nav class="navbar navbar-expand">
                        <div class="collapse navbar-collapse">
                            <div class="header-left">
                                <div class="dashboard_bar">Update Recruitment</div>
                            </div>
            ...
            <div class="content-body">
                ...
                <div class="container-fluid">
                    <!-- Row -->
                    <form action="update_recruitment" method="post">
                        <input type="hidden" name="recruitmentId" value="${requestScope.item.recruitmentID}" />
                        <div class="row">
                            <div class="col-xl-12">
                                <div class="row">
                                    <div class="col-xl-12">
                                            ...
                                            <div class="card h-auto">
                                                <div class="card-body pt-3">
                                                    <input type="text" class="form-control" placeholder="Vacancies"
                                                           name="vacancies" required="" value="${requestScope.item.vacancies}"/>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="card h-auto">
                                            <div class="card-body pt-3">
                                                <input type ="number" id="numberNeeded" placeholder="numberNeeded" style="margin-top: 10px"
                                                       class="form-control" name="numberNeeded" value="${requestScope.item.numberNeeded}" required =""/>
                                            </div>
                                        </div>
                                        ...
                                        <div class="card h-auto">
                                            <div class="card-body pt-3">
                                                <label class="switch">
                                                    <input <c:if test="${requestScope.item.isDisplay}">checked</c:if> name="display" type="checkbox">
